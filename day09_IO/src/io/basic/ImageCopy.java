 ...
 * ----------------------------------------------- -- 입력 -- 1. node stream
 * (FileInputStream) 2. read 작업 : node stream 메소드로 작업 : read()
 * 
 * -- 출력 -- 3. node stream (FileOutputStream) 4. write 작업 : node stream 메소드로 작업
 * : write();
 * 
 * -- 정리 -- 5. 입력 node stream 닫기 6. 출력 node stream 닫기
 * 
 * @author JACK
 *
 */
